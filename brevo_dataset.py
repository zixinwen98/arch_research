...
CLI usage examples:
  ...
  python brevo_dataset.py --variant brevo1 --Nset 110,90,70 --num 100 > brevo1.jsonl
  python brevo_dataset.py --variant brevo2 --Nset 50,40,30  --num 100 > brevo2.jsonl

  # Single JSON array
  python brevo_dataset.py --variant brevo2 --Nset 50,40,30 --num 100 --format json --output brevo.json
"""
